...
$operationalHoursDisplay = htmlspecialchars($footerWorkDays) . ': ' . htmlspecialchars($footerWorkHours) . '<br>' . htmlspecialchars($footerWorkDaysSat) . ': ' . htmlspecialchars($footerWorkHoursSat);
        ...
        <div class="container">
            <div class="header-inner">
                ...
                <nav>
                    ...
                    <a href="https://wa.me/<?= htmlspecialchars($hero['wa_number'] ?? '') ?>" target="_blank">Hubungi Kami</a>
                </nav>
                <a href="https://wa.me/<?= htmlspecialchars($hero['wa_number']) ?>" class="btn-hubungi" target="_blank" aria-label="Hubungi Kami melalui WhatsApp di Menu Navigasi">
                    Hubungi Kami
                </a>
            </div>
        </div>
