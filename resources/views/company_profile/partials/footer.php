...
// Build operational hours string - 2 baris
$operationalHours = htmlspecialchars($footerWorkDays) . ': ' . htmlspecialchars($footerWorkHours) . '<br>' . htmlspecialchars($footerWorkDaysSat) . ': ' . htmlspecialchars($footerWorkHoursSat);
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <?php if (!empty($footerQuickLinks)): ?>
                        <?php foreach ($footerQuickLinks as $link): ?>
                            ...
                            if (strpos($url, 'wa.me/') !== false) {
                                $url = 'https://wa.me/' . str_replace([' ', '-'], '', $footerPhone);
                            }
                            ?>
                            <li>
                    ...
                    <?php else: ?>
                        ...
                        <li><a href="https://wa.me/<?= str_replace([' ', '-'], '', $footerPhone) ?>">Hubungi Kami</a></li>
