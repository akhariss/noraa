...
<div class="users-action-card">
    <div class="users-filter-grid">
        ...
        <div class="filter-group">
            <label class="filter-label">Filter Hak Akses</label>
        ...
        <!-- Grid Item 3: Aksi -->
        <div class="filter-group">
            <label class="filter-label mobile-hide-label" style="opacity: 0;">Aksi</label> <!-- Invisible label to push buttons down on desktop -->
        ...
        <form id="addUserForm">
            ...
            <div style="margin-bottom: 20px;">
                <label style="
                    ...
                    font-size: 14px;
                ">Username</label>
                <input type="text" id="new_username" name="username" required autocomplete="username" style="
                    width: 100%;
                    padding: 12px 16px;
                    border: 1px solid var(--border);
                    border-radius: 8px;
            ...
            <div style="margin-bottom: 20px;">
                <label style="
                    ...
                    font-size: 14px;
                ">Password</label>
                <input type="password" id="new_password" name="password" required minlength="6" autocomplete="new-password" style="
                    width: 100%;
                    padding: 12px 16px;
                    border: 1px solid var(--border);
                    border-radius: 8px;
                    ...
                    font-family: inherit;
                ">
                <small style="color: var(--text-muted); font-size: 12px; display: block; margin-top: 4px;">Minimal 6 karakter</small>
            </div>
            ...
            <div style="margin-bottom: 24px;">
                <label style="
                    ...
                    font-size: 14px;
                ">Role</label>
                <select id="new_role" name="role" required style="
                    width: 100%;
                    padding: 12px 16px;
                    border: 1px solid var(--border);
                    border-radius: 8px;
                ...
                ">
                    <option value="staff">👤 Staff</option>
                    <option value="trusted">🛡️ Trusted Admin</option>
                    <option value="administrator">👑 Administrator</option>
                </select>
            </div>
...
<div id="addUserModal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); z-index: 9998; align-items: center; justify-content: center;">
    <div style="background: var(--white); border-radius: 12px; padding: 32px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="addUserForm">
            <input type="hidden" name="csrf_token" value="<?= generateCSRFToken() ?>">
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: var(--text); font-size: 14px;">Nama Lengkap</label>
                <input type="text" name="name" required placeholder="Ahmad Notaris, S.H." style="width: 100%; padding: 12px 16px; border: 1px solid var(--border); border-radius: 8px; font-size: 14px; font-family: inherit;">
            </div>
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: var(--text); font-size: 14px;">Username</label>
                <input type="text" name="username" required placeholder="Contoh: ahmad_n" style="width: 100%; padding: 12px 16px; border: 1px solid var(--border); border-radius: 8px; font-size: 14px; font-family: inherit;">
            </div>
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: var(--text); font-size: 14px;">Password</label>
                <input type="password" name="password" required minlength="6" autocomplete="new-password" style="width: 100%; padding: 12px 16px; border: 1px solid var(--border); border-radius: 8px; font-size: 14px; font-family: inherit;">
            </div>
            <div style="margin-bottom: 24px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: var(--text); font-size: 14px;">Role</label>
                <select name="role" required style="width: 100%; padding: 12px 16px; border: 1px solid var(--border); border-radius: 8px; font-size: 14px; font-family: inherit;">
                    <option value="staff">👤 Staff</option>
                    <option value="administrator">👑 Administrator</option>
                </select>
            </div>
...
<div id="editUserModal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); z-index: 9998; align-items: center; justify-content: center;">
    <div style="background: var(--white); border-radius: 12px; padding: 32px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="editUserForm">
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: var(--text); font-size: 14px;">Password Baru (Opsional)</label>
