        ...
        <div style="overflow-x: auto;">
            ...
            "                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="padding: 40px; text-align: center; color: var(--text-muted);">Belum ada riwayat perubahan</td>
                    </tr>
                    <?php else: ?>
                    <?php 
                    ...
                    <tr style="border-bottom: 1px solid var(--border);">
                        ...
                        <td style="padding: 14px 16px; font-size: 12px; color: var(--text-light); white-space: nowrap;">
                            ...
                            $oldLabel = STATUS_LABELS[$oldStatus] ?? $oldStatus;
                            $newLabel = STATUS_LABELS[$newStatus] ?? $newStatus;
