...
// DEBUG OUTPUT - Remove after fix
echo "<!-- DEBUG: cms_editor_grid.php loaded -->";
echo "<!-- DEBUG: currentUser=" . (isset($currentUser) ? 'SET' : 'NOT SET') . " -->";
echo "<!-- DEBUG: auth=" . (isset($auth) ? 'SET' : 'NOT SET') . " -->";
echo "<!-- DEBUG: cmsStats=" . (isset($cmsStats) ? 'SET' : 'NOT SET') . " -->";
echo "<!-- DEBUG: VIEWS_PATH=" . (defined('VIEWS_PATH') ? VIEWS_PATH : 'NOT DEFINED') . " -->";
...
if (!defined('VIEWS_PATH')) {
    die('FATAL ERROR: VIEWS_PATH not defined!');
}
