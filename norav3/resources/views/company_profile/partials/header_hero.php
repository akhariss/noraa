...
<head>
    ...
    <title><?= e($brandName) ?> - <?= e($hero['badge']) ?></title>
    <meta name="description" content="<?= e(!empty($hero['description']) ? $hero['description'] : 'Notaris Cirebon, Notaris Sri Anah SH.M.Kn, PPAT Cirebon. Pendamping Hukum Resmi untuk Properti, Usaha, dan Keluarga.') ?>">
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="<?= e($brandName) ?> - <?= e($hero['badge']) ?>">
    <meta property="og:description" content="<?= e($hero['description']) ?>">
    <meta property="og:image" content="<?= e($ogImage) ?>">
    <meta property="og:url" content="<?= e($pageUrl) ?>">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="<?= e($brandName) ?>">
    
    <!-- JSON-LD Structured Data (SEO H-05) -->
    <script type="application/ld+json">
    {
      ...
      "name": "<?= e($brandName) ?>",
      "image": "<?= e($ogImage) ?>",
      "telephone": "+<?= sanitizePhoneForWa($hero['wa_number']) ?>",
      "url": "<?= e(APP_URL) ?>",
      "address": {
        "@type": "PostalAddress",
