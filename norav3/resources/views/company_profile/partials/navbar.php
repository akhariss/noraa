...
?>
    ...
    <!-- Mobile Sidebar & Overlay (Moved OUTSIDE <header> to prevent clipping) -->
    ...
    <nav id="nav-menu">
        ...
        <a href="<?= APP_URL ?>/index.php">
            <svg class="mobile-only" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
            Beranda
        </a>
        <a href="<?= APP_URL ?>/index.php#masalah">
            <svg class="mobile-only" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
            FAQ
        </a>
        <a href="<?= APP_URL ?>/index.php?gate=lacak">
            <svg class="mobile-only" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
            Lacak
        </a>
        <a href="<?= APP_URL ?>/index.php#tentang">
            <svg class="mobile-only" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
            Tentang
        </a>
        ...
        <div class="sidebar-footer mobile-only">
            <div class="footer-contact-item">
                ...
                <div class="contact-text">
                    ...
                    <a href="mailto:info@example.com" class="contact-value">info@example.com</a>
                </div>
            </div>
        </div>
    </nav>
