 ...
 * Roles: ROLE_OWNER (Administrator), ROLE_STAFF (Staff)
 */
...
Router::add('office', 'GET',  [AuthController::class, 'showLoginPage'], []);
...
// ═══════════════════════════════════════════════════════════════
Router::add('dashboard',         'GET',  [DashboardController::class, 'registrasi'],       ['auth' => true]);
...
// Transaksi (Pembayaran) Actions
Router::add('transaksi_store',  'POST', [DashboardController::class, 'transaksiStore'],  ['auth' => true]);
...
Router::add('update_status_list', 'GET', [DashboardController::class, 'updateStatusList'], ['auth' => true]);
Router::add('review',            'GET', [FinalisasiController::class, 'review'],           ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('penyerahan',        'GET', [DashboardController::class, 'penyerahan'],        ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('arsip',             'GET', [DashboardController::class, 'arsip'],             ['auth' => true]);
Router::add('laporan',           'GET', [DashboardController::class, 'laporan'],           ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('laporan_registrasi','GET', [DashboardController::class, 'laporanRegistrasi'], ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('laporan_keuangan',  'GET', [DashboardController::class, 'laporanKeuangan'],   ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('laporan_aktivitas', 'GET', [DashboardController::class, 'laporanAktivitas'],  ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('app_settings',      'GET', [DashboardController::class, 'appSettings'],       ['auth' => true, 'role' => ROLE_OWNER]);
...
Router::add('cms_save_workflow', 'POST', [CMSEditorController::class, 'saveWorkflowStep'],    ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('cms_delete_workflow','POST',[CMSEditorController::class, 'deleteWorkflowStep'],  ['auth' => true, 'role' => ROLE_OWNER]);
Router::add('cms_reorder_workflow','POST',[CMSEditorController::class,'reorderWorkflowSteps'],['auth' => true, 'role' => ROLE_OWNER]);
