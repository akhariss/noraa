<?php
/**
 * Review View - Finalisasi-style table for behavior 8,7
 * Search only, no smart filter.
 */

$currentUser = getCurrentUser();
$pageTitle = 'Review Registrasi';
$activePage = 'review';
...
<div class="hero-authority">
    <span class="hero-badge-auth">Review & Finalisasi</span>
    <p class="hero-p-auth">Tinjau dan finalisasi registrasi yang menunggu keputusan</p>
</div>

<!-- Command Area -->
<div class="action-vault-v5">
    <form method="GET" action="" id="reviewForm">
        <input type="hidden" name="gate" value="review">
        ...
        <div class="f-row-v5">
            ...
            <button type="button" onclick="window.location.href='?gate=review'" class="tab-v5" style="padding:10px; background:#fff; border:1px solid #eee;" title="Reset">
        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr class="lx-row">
                    ...
                    <td style="text-align: center;">
                        <a href="<?= APP_URL ?>/index.php?gate=registrasi_detail_finalisasi&id=<?= $p['id'] ?>&from=review" class="btn-auth-detail"><i>o</i> Detail</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
...
function debounceSearch() {
    ...
    searchTimer = setTimeout(() => { document.getElementById('reviewForm').submit(); }, 800);
}
