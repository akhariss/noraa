...
<div class="audit-body">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 30px;" class="no-print">
        ...
        <div style="display:flex; gap:10px;">
            ...
            <a href="index.php?gate=laporan_registrasi&start=<?= $startDate ?>&end=<?= $endDate ?>&format=download" class="lx-btn-download">
            ...
            <div class="card-body-lx" style="padding: 15px 25px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(<?= ceil(count($matrix['steps_aktif'])/2) ?>, 1fr); gap: 8px 15px; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid #f1f5f9;">
                    ...
                    <div style="display: flex; align-items: center; gap: 8px; font-size: 10px;">
                        ...
                        <span style="font-weight: 800; color: var(--primary); white-space: nowrap;"><?= $s['label'] ?></span>
                    </div>
                    <?php endforeach; ?>
                </div>
                    ...
                    <table class="lx-matrix-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 15px; font-weight: 800; font-size: 11px;"><?= $row['nomor'] ?></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <?php if ($days !== null): ?>
                                        <span class="day-tag <?= $isOver ? 'day-overdue' : 'day-done' ?>"><?= $days ?>d</span>
                                    <?php else: ?>
                                        <span style="color: #f1f1f1;">-</span>
                                    <?php endif; ?>
                                </td>
