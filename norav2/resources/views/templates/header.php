    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?= APP_URL ?>/index.php?gate=registrasi_create" class="nav-item <?= ($activePage ?? '') === 'registrasi_create' ? 'active' : '' ?>" style="padding-left: 44px; font-size: 13px; opacity: 0.85;">
