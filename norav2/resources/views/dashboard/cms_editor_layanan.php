...
.btn-add-luxe {
    background: var(--navy); color: var(--gold-light); border: none; padding: 12px 28px; border-radius: 50px;
...
.btn-nora-submit { background: var(--navy); color: var(--gold-light); padding: 12px 35px; border-radius: 50px; font-weight: 950; font-size: 13px; border: none; cursor: pointer; transition: 0.2s; }
...
#toast { position: fixed; bottom: 30px; right: 30px; background: var(--navy); color: var(--gold-light); padding: 18px 35px; border-radius: 14px; font-weight: 950; box-shadow: 0 15px 40px rgba(0,0,0,0.2); border-left: 6px solid var(--gold); z-index: 12000; animation: slideIn 0.3s forwards; display: none; }
