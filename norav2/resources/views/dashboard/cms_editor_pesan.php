...
.btn-pc-edit {
    background: var(--navy); color: var(--gold-light); border: none; padding: 8px 18px; border-radius: 50px;
...
.btn-nora-submit { background: var(--navy); color: var(--gold-light); border: none; padding: 12px 40px; border-radius: 50px; font-size: 13px; font-weight: 950; cursor: pointer; transition: 0.2s; }
...
/* Toast */
#toast { position: fixed; bottom: 30px; right: 30px; background: var(--navy); color: var(--gold-light); padding: 20px 40px; border-radius: 16px; font-weight: 950; box-shadow: 0 15px 40px rgba(0,0,0,0.2); border-left: 6px solid var(--gold); z-index: 100000; display: none; }
</style>
