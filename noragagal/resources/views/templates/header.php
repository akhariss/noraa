...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars(APP_URL) ?>/public/assets/css/variables.css?v=<?= time() ?>">
    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="<?= url('dashboard') ?>" class="nav-item <?= ($activePage ?? '') === 'dashboard' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?= url('registrasi') ?>" class="nav-item <?= ($activePage ?? '') === 'registrasi' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
                    </svg>
                ...
                <a href="<?= url('registrasi_create') ?>" class="nav-item <?= ($activePage ?? '') === 'registrasi_create' ? 'active' : '' ?>" style="padding-left: 44px; font-size: 13px; opacity: 0.85;">
                ...
                <a href="<?= url('finalisasi') ?>" class="nav-item <?= ($activePage ?? '') === 'finalisasi' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?= url('users') ?>" class="nav-item <?= ($activePage ?? '') === 'users' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?= url('cms_editor') ?>" class="nav-item <?= ($activePage ?? '') === 'cms' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?= url('backups') ?>" class="nav-item <?= ($activePage ?? '') === 'backups' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?= url('audit') ?>" class="nav-item <?= ($activePage ?? '') === 'audit' ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
