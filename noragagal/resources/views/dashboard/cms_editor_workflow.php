...
.btn-action-navy { background: var(--navy); color: var(--gold-light); border: none; padding: 10px 25px; border-radius: 50px; font-size: 11px; font-weight: 950; cursor: pointer; transition: 0.2s; }
...
.btn-mini-edit:hover { background: var(--navy); color: var(--gold-light); border-color: var(--navy); transform: scale(1.05); }
...
.lcs-tag { font-size: 10px; font-weight: 950; background: var(--navy); color: var(--gold-light); padding: 4px 8px; border-radius: 6px; }
...
.btn-nora-submit-sm { background: var(--navy); color: var(--gold-light); padding: 12px 30px; border-radius: 50px; font-weight: 950; font-size: 12px; border: none; cursor: pointer; transition: 0.2s; }
