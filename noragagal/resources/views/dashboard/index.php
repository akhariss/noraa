...
<style>
    ...
    .hero-banner h1 { font-family: 'Cormorant Garamond', serif; color: var(--gold); font-size: 28px; margin: 0 0 10px 0; letter-spacing: 1px; }
...
<div class="war-room-container">
    ...
    <div class="analytics-grid">
        <div class="node-swd">
            <h3 style="font-size:14px; color:var(--gold); margin-bottom:15px; font-family:'Cormorant Garamond', serif; font-weight:700;">NARASI TAKTIS AA</h3>
