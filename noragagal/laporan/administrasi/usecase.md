...
actor "Notaris (Owner)" as O

rectangle "Sistem NORA v2.1" {
  usecase "Lacak Berkas (Self-Service)" as UC_Lacak
  usecase "Login Sistem" as UC_Login
  usecase "Input Registrasi Baru" as UC_Reg
  usecase "Update 15 Status Berkas" as UC_Status
  usecase "CMS & Workflow Config" as UC_CMS
  usecase "Finalisasi & Tutup Kasus" as UC_Final
}
