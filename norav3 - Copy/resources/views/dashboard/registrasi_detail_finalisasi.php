...
$from = $_GET['from'] ?? '';
$activePage = !empty($from) ? $from : 'finalisasi';
$backUrl = APP_URL . '/index.php?gate=' . (!empty($from) ? $from : 'finalisasi');
$backLabel = 'Kembali ke Daftar ' . (!empty($from) ? ucwords(str_replace(['_', 'list'], [' ', ''], $from)) : 'Finalisasi');
    ...
    <div class="nora-detail-card" style="margin-top: 20px;">
        <div class="nora-detail-body">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; flex-wrap: wrap; gap: 12px;">
                ...
                <a href="<?= APP_URL ?>/index.php?gate=registrasi_history&id=<?= $registrasi['id'] ?>" class="btn-sm" style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px; background: var(--primary); color: white; border-radius: 6px; font-size: 11px; font-weight: 600; text-decoration: none;">
