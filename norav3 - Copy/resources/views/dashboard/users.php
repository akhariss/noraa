    ...
    <div style="background: var(--white); border-radius: 12px; padding: 32px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="addUserForm">
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end;">
                ...
                <button type="submit" style="background: var(--primary); color: white; padding: 12px 24px; border: none; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer;">Simpan User</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div style="background: var(--white); border-radius: 12px; padding: 32px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="editUserForm">
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end;">
                ...
                <button type="submit" style="background: var(--primary); color: white; padding: 12px 24px; border: none; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer;">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
